  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // PERBAIKAN: Menggunakan Stack agar Card Form tidak memakan spasi kosong
        child: Stack(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildTextField(label: "Username", icon: Icons.alternate_email, controller: _usernameController, type: TextInputType.text),
                        const SizedBox(height: 20),
                  ...
                  // Link ke Register (Sekarang Jaraknya Pas!)
                  Row(
